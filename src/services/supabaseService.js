...
function mapDbBlogToModel(db) {
  ...
  return {
    ...
    author: db.author && typeof db.author === 'object' ? db.author : { name: 'Sravan Sudhakaran', role: 'Cognitive Strategist & Founder', avatar: '/instructor.png' },
...
function mapModelToDbBlog(model) {
  return {
    ...
    author: model.author || { name: 'Sravan Sudhakaran', role: 'Cognitive Strategist & Founder', avatar: '/instructor.png' },
