...
export default function CommunityRegister() {
  ...
  return (
    <div className="min-h-screen bg-[#070A11] text-[#FAFAF7] flex flex-col items-center justify-center p-4 sm:p-6 relative overflow-hidden selection:bg-[#FFC857] selection:text-[#070A11]">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[350px] bg-[#7C5CFC]/15 blur-[140px] rounded-full pointer-events-none -z-10" />
      <div className="absolute bottom-0 right-10 w-[450px] h-[300px] bg-[#FFC857]/10 blur-[150px] rounded-full pointer-events-none -z-10" />
      ...
      {/* Main Container */}
      <div className="relative z-10 w-full max-w-lg glass-card-luxury rounded-2xl p-6 sm:p-8 shadow-2xl">
        {!registeredMember ? (
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-black/40 border border-white/10 focus:border-[#FFC857]/60 rounded-xl px-4 py-2.5 text-sm text-white placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-[#FFC857]/40 transition-all resize-none glass-specular"
                />
              </div>
